...
public class ModItems {
    ...
    public static final RegistryObject<Item> ECHOVIUM_UPGRADE_SMITHING_TEMPLATE = ITEMS.register("echovium_upgrade_smithing_template",
            () -> new SmithingTemplateItem(Component.translatable("item.testmod.echovium_upgrade.applies_to").withStyle(ChatFormatting.BLUE),
                    Component.translatable("item.testmod.echovium_upgrade.ingredients").withStyle(ChatFormatting.BLUE),
                    Component.translatable("item.testmod.echovium_upgrade.title").withStyle(ChatFormatting.GRAY),
                    Component.translatable("item.testmod.echovium_upgrade.base_slot_description"),
                    Component.translatable("item.testmod.echovium_upgrade.additions_slot_description"),
    ...
    private static List<ResourceLocation> createEchoviumUpgradeEmptyAdditionsSlotTextures() {
        return List.of(
                ResourceLocation.fromNamespaceAndPath(TestMod.MOD_ID, "item/empty_slot_echovium")
        );
    }
